...
local token =
  [[eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJqd3QtZWRpdG9yLTEiLCJ0ZW5hbnQiOiJqd3QtdGVuYW50LTEiLCJyb2xlIjoiZWRpdG9yIn0.SZtRcFbtUVjr9K1WkmVUfUMEfW7Zx8sCJ_cvQ5RYesg]]
local msg = { jwt = token }
